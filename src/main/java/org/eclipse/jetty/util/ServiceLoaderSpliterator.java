...
/**
 * <strong>LICENSE NOTE</strong>: This is the modified version (made public) of the original
 * {@code org.eclipse.jetty.util.ServiceLoaderSpliterator} class in the jetty-util project.
 */
public class ServiceLoaderSpliterator<T> implements Spliterator<ServiceLoader.Provider<T>>
{
