...
import com.picimako.org.apache.lucene.luke.app.desktop.components.SearchTabOperator;
 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.fragments.search.SortPaneProvider}.
 */
public final class SortPaneProvider implements SortTabOperator {
  ...
  private final JComboBox<String> fieldCombo1 = new ComboBox<>();

  private final JComboBox<String> typeCombo1 = new ComboBox<>();

  private final JComboBox<String> orderCombo1 = new ComboBox<>(Order.names());

  private final JComboBox<String> fieldCombo2 = new ComboBox<>();

  private final JComboBox<String> typeCombo2 = new ComboBox<>();

  private final JComboBox<String> orderCombo2 = new ComboBox<>(Order.names());
