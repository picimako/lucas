 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.fragments.analysis.SimpleAnalyzeResultPanelProvider}.
 */
public class SimpleAnalyzeResultPanelProvider implements SimpleAnalyzeResultPanelOperator {

  private final ComponentOperatorRegistry operatorRegistry;

  private final JTable tokensTable = new JBTable();
  ...
  public SimpleAnalyzeResultPanelProvider(Project project) {
  ...
  public JPanel get() {
    ...
    panel.add(new JBScrollPane(tokensTable), BorderLayout.CENTER);
