...
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.analysis.TokenAttributeDialogFactory;
 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.fragments.analysis.StepByStepAnalyzeResultPanelProvider}.
 */
public class StepByStepAnalyzeResultPanelProvider implements StepByStepAnalyzeResultPanelOperator {

  private final ComponentOperatorRegistry operatorRegistry;

  private final JTable charfilterTextsTable = new JBTable();

  private final JTable charfilterTextsRowHeader = new JBTable();

  private final JTable namedTokensTable = new JBTable();

  private final JTable namedTokensRowHeader = new JBTable();
  ...
  public StepByStepAnalyzeResultPanelProvider(Project project) {
  ...
  private JScrollPane initResultScroll(JTable table, JTable header) {
    ...
    scroll.setCorner(ScrollPaneConstants.UPPER_LEFT_CORNER, header.getTableHeader());
...
//    To bypass building an analyzer, uncomment this
    analysisModel.buildCustomAnalyzer(new org.apache.lucene.luke.models.analysis.CustomAnalyzerConfig.Builder("keyword", Map.of()).build());
  ...
  private void showAttributeValues(int rowIndex, int columnIndex) {
    ...
    if (rowIndex <= tokens.size()) {
      ...
      new TokenAttributeDialogFactory(project, term, attributes).show();
    }
  }
