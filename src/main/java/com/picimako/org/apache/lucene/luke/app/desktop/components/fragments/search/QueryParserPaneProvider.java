 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.fragments.search.QueryParserPaneProvider}.
 */
public final class QueryParserPaneProvider implements QueryParserTabOperator {
  ...
  private final JComboBox<String> dfCB = new ComboBox<>();
  ...
  private final JComboBox<String> dateResCB = new ComboBox<>();

  private final JTextField locationTF = new JTextField();

  private final JTextField timezoneTF = new JTextField();

  private final JTable pointRangeQueryTable = new JBTable();
  ...
  private JPanel initPointRangeQuerySettingsPanel() {
    ...
    JScrollPane scrollPane = new JBScrollPane(pointRangeQueryTable);
  ...
  public void setRangeSearchableFields(Collection<String> rangeSearchableFields) {
    ...
    String[] numTypes =
        Arrays.stream(PointTypesTableModel.NumType.values())
            ...
            .toArray(String[]::new);
    JComboBox<String> numTypesCombo = new ComboBox<>(numTypes);
