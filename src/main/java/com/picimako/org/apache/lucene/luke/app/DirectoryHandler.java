 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.DirectoryHandler}.
 */
...
public final class DirectoryHandler extends AbstractHandler<DirectoryObserver> {
  ...
  public static DirectoryHandler getInstance() {
    return ApplicationManager.getApplication().getService(DirectoryHandler.class);
  }
