...
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.documents.AddDocumentDialogFactory;
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.documents.DocValuesDialogFactory;
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.documents.StoredValueDialogFactory;
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.documents.TermVectorDialogFactory;
 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.DocumentsPanelProvider}.
 */
public final class DocumentsPanelProvider implements DocumentsTabOperator {
  ...
  private final JComboBox<String> fieldsCombo = new ComboBox<>();
  ...
  private final JTable posTable = new JBTable();
  ...
  private final JButton addDocBtn = new JButton(AllIcons.Actions.AddFile);

  private final JButton copyDocValuesBtn = new JButton(AllIcons.Actions.Copy);

  private final JTable documentTable = new JBTable();
  ...
  public DocumentsPanelProvider(Project project) {
    this.project = project;
    this.messageBroker = MessageBroker.getInstance();
    this.operatorRegistry = ComponentOperatorRegistry.getInstance();
    this.tabSwitcher = TabSwitcherProxy.getInstance();
    this.addDocDialogFactory = new AddDocumentDialogFactory();
  ...
  private JComponent createFlagsHelpDialog() {
    ...
    JList<String> list = new JBList<>(values);
  ...
  private JPanel initBrowseTermsPanel() {
    ...
    firstTermBtn.setIcon(AllIcons.Diff.Arrow);
  ...
  private JPanel initBrowseDocsByTermPanel() {
    ...
    selectedTermTF.setBackground(JBColor.WHITE);
    c.gridx = 0;
    c.gridy = 1;
    c.weightx = 0.0;
    c.gridwidth = 2;
    ...
    firstTermDocBtn.setIcon(AllIcons.Diff.Arrow);
    ...
    c.weightx = 0.2;
    c.gridwidth = 1;
    c.insets = JBUI.insets(5, 3, 5, 5);
    center.add(firstTermDocBtn, c);

    termDocIdxTF.setEditable(false);
    termDocIdxTF.setBackground(JBColor.WHITE);
    c.gridx = 1;
    c.gridy = 2;
    c.weightx = 0.5;
    c.gridwidth = 1;
    ...
    JScrollPane scrollPane = new JBScrollPane(posTable);
  ...
  private JPanel initLowerPanel() {
    ...
    JScrollPane scrollPane = new JBScrollPane(documentTable);
  ...
  private JPanel initBrowseDocsBar() {
    ...
    JLabel label = new JLabel(MessageUtils.getLocalizedMessage("documents.label.browse_doc_by_idx"));
    label.setIcon(AllIcons.Actions.Annotate);
    ...
    copyDocValuesBtn.setMargin(JBUI.insets(5, 0));
  ...
  private void showAddDocumentDialog() {
    addDocDialogFactory.createDialog(project).show();
  }
  ...
  private void showTermVectorDialog() {
    ...
    new TermVectorDialogFactory(project, field, tvEntries).show();
    messageBroker.clearStatusMessage();
  }
  ...
  private void showDocValuesDialog() {
    ...
    if (docValues.isPresent()) {
      new DocValuesDialogFactory(project, field, docValues.get()).show();
      messageBroker.clearStatusMessage();
    } else {
      messageBroker.showStatusMessage(
          MessageUtils.getLocalizedMessage(
  ...
  private void showStoredValueDialog() {
    ...
    new StoredValueDialogFactory(project, field, value).show();
    messageBroker.clearStatusMessage();
  }
