 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.IndexHandler}.
 */
...
public final class IndexHandler extends AbstractHandler<IndexObserver> {
  ...
  public static IndexHandler getInstance() {
    return ApplicationManager.getApplication().getService(IndexHandler.class);
  }
  ...
  public void open(
    ...
    try {
      ...
      try {
        ...
        PreferencesImpl.getInstance().removeHistory(indexPath);
