 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.LogsPanelProvider}.
 */
public final class LogsPanelProvider {
  ...
  public JPanel get() {
    ...
    copyBtn.setMargin(JBUI.insets(3));
    ...
    panel.add(new JBScrollPane(logTextArea), BorderLayout.CENTER);
    return panel;
  }
