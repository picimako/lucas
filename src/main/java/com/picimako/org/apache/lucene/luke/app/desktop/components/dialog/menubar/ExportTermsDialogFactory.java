 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.components.dialog.menubar.ExportTermsDialogFactory}.
 */
public final class ExportTermsDialogFactory implements DialogFactory<ExportTermsDialog> {
  ...
  public ExportTermsDialogFactory() {
    this.indexHandler = IndexHandler.getInstance();
    indexHandler.addObserver(new Observer());
  }

  @Override
  public ExportTermsDialog createDialog(@NotNull Project project) {
    return new ExportTermsDialog(project, toolsModel, lukeState);
  }
