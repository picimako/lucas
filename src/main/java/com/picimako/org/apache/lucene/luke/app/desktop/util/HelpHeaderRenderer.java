...
package com.picimako.org.apache.lucene.luke.app.desktop.util;

import com.intellij.icons.AllIcons;
import com.intellij.openapi.project.Project;
import com.picimako.org.apache.lucene.luke.app.desktop.LukeMain;
import com.picimako.org.apache.lucene.luke.app.desktop.components.dialog.HelpDialogFactory;
 ...
 * <p>
 * LICENSE NOTE: This is the modified version of {@link org.apache.lucene.luke.app.desktop.util.HelpHeaderRenderer}.
 */
public final class HelpHeaderRenderer implements TableCellRenderer {
  ...
  public HelpHeaderRenderer(
      String title, String desc, JComponent helpContent, Project project) {
    this(title, desc, helpContent, project, null);
  }
    ...
    private void showPopupIfNeeded(MouseEvent e) {
      ...
      if (column == this.column && e.getClickCount() == 1 && column != -1) {
        ...
        if (Objects.nonNull(parent)) {
          new HelpDialogFactory(project, parent, title, desc, helpContent).show();
        } else {
          new HelpDialogFactory(project, LukeMain.getOwnerFrame(), title, desc, helpContent).show();
        }
      }
    }
  }
